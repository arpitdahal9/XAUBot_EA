"""
GBPJPY Backtest Script
Tests the trading bot on GBP/JPY
"""
import sys
import os
...
backtester = Backtester(
    ...
    spread_pips=2.0,  # GBPJPY typically has wider spread
    slippage_pips=1.0
)
...
try:
    ...
    try:
        ...
        print(f"Failed to load GBPJPY data: {e2}")
        sys.exit(1)
...
# Export trades
csv_path = "backtest_gbpjpy_trades.csv"
